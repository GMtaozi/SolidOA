...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'flow-config', name: 'FlowConfig', component: () => import('@/views/system/flow-config/index.vue'), meta: { title: '流程配置', roles: ['SYSTEM_ADMIN'] } },
      { path: 'stamp-manage', name: 'StampManage', component: () => import('@/views/system/stamp-manage/index.vue'), meta: { title: '印章管理', roles: ['SYSTEM_ADMIN'] } },
      { path: 'stamp-record', name: 'StampRecord', component: () => import('@/views/system/stamp-record/index.vue'), meta: { title: '用印记录', roles: ['SYSTEM_ADMIN'] } },
