...
export const api = {
  ...
  getUserInfo: () => request.get('/api/v1/auth/userinfo'),
  logout: () => request.post('/api/v1/auth/logout'),  // 登出
  ...
  getTodayCheckIn: () => request.get('/api/v1/attendance/today'),

  // 消息
  getMessageList: (params) => request.get('/api/v1/collab/messages', params),
  getUnreadCount: () => request.get('/api/v1/collab/messages/unread/count'),
